...
const ContactPage = () => {
  ...
  ------------------------------------------------------------> */}
        ...
        <form id="contact-form" ref={form} onSubmit={sendEmail}>
          <h1 class="contact-title text-center mb-4">Talk to Us</h1>

          {/* <!-- Name --> */}
          <div class="contact-form-group position-relative">
            <label for="formName" class="d-block">
              <i class="contact-icon" data-feather="user"></i>
            </label>
            <div className="contact-input">
              <input
                name="user_name"
                id="formName"
                class="contact-form-control contact-form-control-lg thick"
                placeholder="Name"
                required
              />
            </div>
          ...
          {/* <!-- Message --> */}
          <div class="contact-form-group contact-message">
            <div className="contact-input">
              <textarea
                name="message"
                class="textarea contact-form-control contact-form-control-lg"
                placeholder="Message"
                required
              ></textarea>
            </div>
